...
// Team member data (in real app, this would be fetched)
...
export default function MemberDetailPage({ params }: { params: { id: string } }) {
  ...
  const member = getMemberData(parseInt(params.id));
      ...
      <section className="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <span className={`px-3 py-1 rounded-full text-sm font-medium ${
              currentTask.daysRemaining <= 1 ? "bg-red-500/20 text-red-400" : "bg-yellow-500/20 text-yellow-400"
            }`}>
