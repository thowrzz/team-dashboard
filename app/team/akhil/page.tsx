...
export default function AkhilPage() {
  ...
  const member = {
    ...
    tasks: [
      {
        ...
        status: "Active",
        progress: 0,
        description: "Managing team documentation and coordination",
      },
    ],
    checkIns: {
    ...
    activityLog: [
      { timestamp: "2026-02-28T08:00:00+05:30", event: "Added to team dashboard", type: "member" },
      { timestamp: "2026-02-28T07:55:00+05:30", event: "Profile created", type: "update" },
    ],
    stats: {
      totalTasks: 0,
      completedTasks: 0,
